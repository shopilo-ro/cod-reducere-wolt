#!/usr/bin/env node
/**
 * Fetch coduri reducere Wolt de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/wolt.com
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/wolt.com";
const STORE_NAME  = "Wolt";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-wolt)" }
  });
