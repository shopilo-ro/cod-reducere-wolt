#!/usr/bin/env python3
"""
Fetch coduri de reducere Wolt de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/wolt.com
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/wolt.com"
STORE_NAME = "Wolt"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Wolt de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-wolt)"
    }
    try:
